...
export default {
  message: {
    ...
    'menu.sqlTest': 'SQL测试',
    'menu.sqlTest.debug': '调试',
    'menu.sqlTest.debug.debug': '调试',
    'menu.sqlTestShort': 'SQL',
    'menu.sqlTest.sqlCase': '用例',
    'menu.sqlTest.sqlCaseRun': '执行',
    'menu.sqlTest.case': '用例',
    'menu.sqlTest.case.recycle': '回收站',
    'menu.sqlTest.sqlReport': '报告',
    ...sys,
    ...localeSettings,
    ...result,
    ...common,
