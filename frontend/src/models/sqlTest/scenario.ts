...
// 场景步骤详情
// TODO：可以看一下ms原来的操作步骤detail类型，主要用于展示一些条件操作内容，这里暂时先不做场景步骤显示内容的控制了，全部都是SQL_CASE类型，显示内容也是一样的就行
...
export interface SqlScenario {
    ...
    // stepDetails: Record<string, SqlScenarioStepDetails>; // case、api、脚本操作抽屉的详情结构 TODO
