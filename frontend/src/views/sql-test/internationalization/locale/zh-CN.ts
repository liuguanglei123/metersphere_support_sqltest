export default {
  ...
  'apiTestManagement.allSql': '全部SQL用例',

  'sqlTestManagement.sqlName': 'SQL用例名称',
  'sqlTestManagement.sqlProtocol': 'SQL协议',
  'sqlTestManagement.sqlType': 'SQL类型',

  'common.text.affectedRows': '受影响行：',
  'common.text.result': '结果',
  'common.text.timeConsuming': '耗时',
  'common.text.searchRow': '查询行数',
  'common.text.row': '行',
  'sqlScenario.sql': 'SQL用例',
  'sqlScenario.scenario': 'SQL场景',
