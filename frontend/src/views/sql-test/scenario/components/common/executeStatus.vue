...
<script setup lang="ts">
  ...
  const statusMap = {
    [SqlScenarioExecuteStatus.STOP]: {
      bgColor: 'rgb(var(--link-2))',
      color: 'rgb(var(--link-6))',
      text: 'common.stopped',
    },
    [SqlScenarioExecuteStatus.EXECUTING]: {
      bgColor: 'rgb(var(--link-2))',
      color: 'rgb(var(--link-6))',
      text: 'common.running',
    },
    [SqlScenarioExecuteStatus.FAILED]: {
      bgColor: 'rgb(var(--danger-2))',
      color: 'rgb(var(--danger-6))',
      text: 'common.fail',
    },
    [SqlScenarioExecuteStatus.FAKE_ERROR]: {
      bgColor: 'rgb(var(--warning-2))',
      color: 'rgb(var(--warning-5))',
      text: 'common.fakeError',
    },
    [SqlScenarioExecuteStatus.SUCCESS]: {
      bgColor: 'rgb(var(--success-2))',
      color: 'rgb(var(--success-6))',
      text: 'common.success',
    },
    [SqlScenarioExecuteStatus.UN_EXECUTE]: {
