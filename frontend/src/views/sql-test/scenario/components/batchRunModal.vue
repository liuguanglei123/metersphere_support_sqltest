<template>
  <a-modal v-model:visible="showBatchExecute" title-align="start" class="ms-modal-upload ms-modal-medium" :width="480">
    ...
    <a-form ref="batchExecuteFormRef" class="ms-form rounded-[4px]" :model="batchExecuteForm" layout="vertical">
      <a-form-item field="defaultEnv" :label="'F:' + t('case.execute.selectEnv')">
      ...
      <a-form-item field="runMode" :label="'F:' + t('case.execute.model')">
      ...
      <a-form-item field="integratedReport" :label="'F:' + t('case.execute.reportSetting')">
      ...
      <a-form-item
        ...
        :label="'F:' + t('case.execute.reportName')"
