...
<script setup lang="ts">
  ...
  import {
    ...
    moveModule,
    updateModule,
  } from '@/api/modules/sql-test/scenario';
  ...
  import { SqlScenarioGetModuleParams } from '@/models/sqlTest/scenario';
  ...
  const lastModuleCountParam = ref<SqlScenarioGetModuleParams>({
    projectId: appStore.currentProjectId,
  });

  async function initModuleCount(params: SqlScenarioGetModuleParams) {
    try {
