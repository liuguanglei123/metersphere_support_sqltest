...
<script lang="ts" setup>
  ...
  import MsSqlCard from '@/components/pure/ms-sql-card/index.vue';
  import MsSqlEditableTab from '@/components/pure/ms-sql-editable-tab/index.vue';
  import moduleTree from './components/moduleTree.vue';
  import apiMethodName from '@/views/sql-test/components/apiMethodName.vue';
  import importCurlDialog from '@/views/sql-test/components/importCurlDialog.vue';
  import requestComposition, { RequestParam } from '@/views/sql-test/components/requestComposition/index.vue';
  ...
  import { ExecuteSqlRequestFullParams } from '@/models/sqlTest/common';
  import {
    ProtocolKeyEnum,
    RequestAuthType,
    RequestComposition,
  ...
  const defaultDebugParams2: SqlRequestParam = {
    sql: 'select * from t1;',
    type: 'api',
    id: initDefaultId,
    moduleId: 'root',
  ...
  const debugTabs2 = ref<SqlRequestParam[]>([cloneDeep(defaultDebugParams2)]);
  const activeDebug2 = ref<SqlRequestParam>(debugTabs2.value[0]);
