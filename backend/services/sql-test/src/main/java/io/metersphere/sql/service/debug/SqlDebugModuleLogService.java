...
public class SqlDebugModuleLogService {
    private static final String SQL_DEBUG_MODULE = "/sql/debug/module";
    private static final String ADD = SQL_DEBUG_MODULE + "/add";
    private static final String UPDATE = SQL_DEBUG_MODULE + "/update";
    private static final String DELETE = SQL_DEBUG_MODULE + "/delete";
    private static final String MOVE = SQL_DEBUG_MODULE + "/move";
    ...
    public void saveAddLog(SqlDebugModule module, String operator) {
        Project project = projectMapper.selectByPrimaryKey(module.getProjectId());
        LogDTO dto = LogDTOBuilder.builder()
                .projectId(module.getProjectId())
                .organizationId(project.getOrganizationId())
                .type(OperationLogType.ADD.name())
                .module(OperationLogModule.SQL_TEST_DEBUG_MANAGEMENT_MODULE)
    ...
    public void saveUpdateLog(SqlDebugModule module, String projectId, String operator) {
    ...
    public void saveDeleteDataLog(List<SqlDebug> deleteData, String operator, String projectId) {
        Project project = projectMapper.selectByPrimaryKey(projectId);
