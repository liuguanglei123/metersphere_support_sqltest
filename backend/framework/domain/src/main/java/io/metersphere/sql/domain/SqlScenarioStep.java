...
@Data
public class SqlScenarioStep implements Serializable {
    @Schema(description = "步骤id", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "{sql_scenario_step.id.not_blank}", groups = {Updated.class})
    @Size(min = 1, max = 50, message = "{sql_scenario_step.id.length_range}", groups = {Created.class, Updated.class})
    private String id;

    @Schema(description = "场景id", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "{sql_scenario_step.scenario_id.not_blank}", groups = {Created.class})
    @Size(min = 1, max = 50, message = "{sql_scenario_step.scenario_id.length_range}", groups = {Created.class, Updated.class})
    ...
    @NotNull(message = "{sql_scenario_step.sort.not_blank}", groups = {Created.class})
    private Long sort;
