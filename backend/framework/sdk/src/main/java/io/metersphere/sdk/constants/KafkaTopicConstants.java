...
public class KafkaTopicConstants {
    ...
    public static final String SQL_SCENARIO_RUN_TOPIC = "SQL_SCENARIO_RUN_TOPIC";
    public static final String SQL_SCENARIO_REPORT_TOPIC = "SQL_SCENARIO_REPORT_TOPIC";
